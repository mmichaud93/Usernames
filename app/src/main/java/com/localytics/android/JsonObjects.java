...
/* package */final class JsonObjects
{
    ...
    public static final class BlobHeader
    {
        ...
        public static final class Attributes
        {
             ...
             * Type: {@code String}
             * <p>
             * Initial advertising ID of the device, if the device has installed play service 4.0+ and the parent app is using it.
             * Otherwise null.
             */
            public static final String KEY_DEVICE_ADVERTISING_ID = "gadid"; //$NON-NLS-1$

            /**
             * Type: {@code String}
             * <p>
             * Current advertising ID of the device, if the device has installed play service 4.0+ and the parent app is using it.
             * Otherwise null.
             */
            public static final String KEY_CURRENT_ADVERTISING_ID = "gcadid"; //$NON-NLS-1$
    ...
    /* package */static final class SessionOpen
    {
         ...
         * Type: {@code long}
         * <p>
         * Time since the previous session open
         */
        public static final String KEY_TIME_SINCE_LAST = "sl"; //$NON-NLS-1$
    }
    ...
    /* package */static final class SessionEvent
    {
         ...
         * Type: {@code String}
         * <p>
         * Customer ID (or UUID/install ID if not set)
         */
         ...
         * Type: {@code boolean}
         * <p>
         * Logged in boolean, representing whether the customer ID has been set
         */
    ...
    /**
     * Set of constants for customer profile upload.
     */
    /* package */static final class ProfileUpload
    {
        /**
         * Private constructor prevents instantiation
         *
         ...
         * Type: {@code JSONObject}
         * <p>
         * JSON object with the profile attribute to modify
         */
        public static final String KEY_JSON_ATTRIBUTE = "attributes"; //$NON-NLS-1$
    }
}
