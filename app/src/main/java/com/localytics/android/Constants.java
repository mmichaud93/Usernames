...
/* package */class Constants
{
     ...
     * 2.0: New upload format.
 	 ...
 	 * 2.28: Add support for Google Advertising Id, enabling/disabling push, re-registering push with changed sender id, setting dismiss button image.
 	 * 2.29: Add test mode
 	 * 2.30: Add support for one-line integration
 	 * 2.51: Support for the profiles service
     */
    //@formatter:on
    public static final String LOCALYTICS_CLIENT_LIBRARY_VERSION = "android_2.70"; //$NON-NLS-1$
    ...
    /**
     * Maximum characters in an event name, an event attribute key/value, or a profile attribute key.
     */
    public static final int MAX_NAME_LENGTH = 128;

    /**
     * Maximum characters in a profile attribute value
     */
