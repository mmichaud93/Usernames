...
public final class ReflectionUtils
{
    ...
    /**
     * Use reflection to invoke a static method for a class name and method name
     *
     * @param <T> Type that the method should return
    ...
    /**
     * Use reflection to invoke an instance method for a class object and method name
     *
     * @param <T> Type that the method should return
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T tryInvokeConstructor(final String className, final Class<?>[] types, final Object[] args)
    {
        try
        {
